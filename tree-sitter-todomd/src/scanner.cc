...
// Determines if a character is punctuation as defined by the todomd spec.
...
extern "C" {
    void *tree_sitter_todomd_external_scanner_create() {
        return new TreeSitterTODOMD::Scanner();
    }

    bool tree_sitter_todomd_external_scanner_scan(
        void *payload,
        TSLexer *lexer,
        const bool *valid_symbols
    ) {
        TreeSitterTODOMD::Scanner *scanner = static_cast<TreeSitterTODOMD::Scanner *>(payload);
        scanner->simulate = false;
        return scanner->scan(lexer, valid_symbols);
    }

    unsigned tree_sitter_todomd_external_scanner_serialize(
        void *payload,
        char* buffer
    ) {
        TreeSitterTODOMD::Scanner *scanner = static_cast<TreeSitterTODOMD::Scanner *>(payload);
    ...
    void tree_sitter_todomd_external_scanner_deserialize(
        void *payload,
        char* buffer,
        unsigned length
    ) {
    ...
    void tree_sitter_todomd_external_scanner_destroy(void *payload) {
        TreeSitterTODOMD::Scanner *scanner = static_cast<TreeSitterTODOMD::Scanner *>(payload);
        delete scanner;
    }
}
