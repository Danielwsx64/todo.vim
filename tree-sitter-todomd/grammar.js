...
module.exports = grammar({
  ...
  rules: {
    ...
    _section6: ($) =>
      prec.right(
        seq(alias($._atx_heading6, $.atx_heading), repeat($._block_not_section))
      ),
    ...
    _text_inline_no_link: ($) =>
      choice($._word, $._whitespace, common.punctuation_without($, ["[", "]"])),
    ...
    _word: ($) =>
      choice(
        ...
        common.EXTENSION_TASK_LIST ? choice("[x]", /\[[ \t]\]/) : choice()
      ),
